"""
Constructive derandomization of Valiant routing (Theorem 4.1).

Given target permutation pi, builds an explicit intermediate sigma(pi)
achieving O(log N) congestion via the method of conditional expectations
with an exponential pessimistic estimator.
"""
...
def run_analysis():
    """Compare derandomized vs random Valiant routing."""
